...
names(ldm) <- ldm_names
dbDisconnect(con)
# save(ldm, file = "C:/Users/steph/Nextcloud/data/ldm/LDM-compact_20200422.RData")
load(file = "C:/Users/steph/Nextcloud/data/ldm/LDM-compact_20200422.RData")


# horizon table
chem_vars <- c("labsampnum", "electrical_conductivity_satx", "ec_predict_one_to_two", "ph_h2o", "ph_h2o_method", "ph_saturated_paste", "sodium_absorption_ratio", "exchangeable_sodium")
phys_vars <- c("labsampnum", "texture_lab", "clay_total", "silt_total", "sand_total", "total_frag_wt_pct_gt_2_mm_ws", "bulk_density_third_bar")
...
s <- subset(s, !duplicated(s$pedlabsampnum))
